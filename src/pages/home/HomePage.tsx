...
const HomePage = () => {
    ...
    const travelData = [
        {
            imageUrl:
                'https://mia.vn/media/uploads/blog-du-lich/danh-lam-thang-canh-viet-nam-01-1710680490.jpeg',
            ...
            <div>
                <Carousel autoplay className="relative">
                    ...
                    <div>
                        <img
                            style={imageStyle}
                            src="https://i.pinimg.com/originals/cb/88/9c/cb889c6fb0faa4aed170de4454340f31.jpg"
                        />
                    </div>
                    <div>
                        <img
                            style={imageStyle}
                            src="https://wallpapers.com/images/hd/hanoi-retains-its-traditional-traits-meba8ch7tnlz4k4i.jpg"
                        />
                    </div>
                </Carousel>
